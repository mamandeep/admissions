	...
	<div class="sidebar-collapse">
		<ul class="nav" id="main-menu">
			<li class="text-center user-image-back">
                            <?= $this->Html->image('find_user.png', ['class' => 'img-responsive']) ?>
			</li>
...
<?= $this->Html->script('jquery-1.10.2.js', array('block' => 'scriptBottom')) ?>
<?= $this->Html->script('bootstrap.min.js', array('block' => 'scriptBottom')) ?>
<?= $this->Html->script('jquery.metisMenu.js', array('block' => 'scriptBottom')) ?>
<?= $this->Html->script('custom.js', array('block' => 'scriptBottom')) ?>